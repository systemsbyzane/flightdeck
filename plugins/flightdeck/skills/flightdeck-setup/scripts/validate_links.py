...
REQUIRED = (
    ...
    TEMPLATE / "docs" / "workflows" / "operation-authoring-api.md",
    TEMPLATE / "docs" / "workflows" / "operation-projection-api.md",
    TEMPLATE / "docs" / "architecture" / "hub-first.md",
    ...
    TEMPLATE / "hub" / "schemas" / "hub-snapshot.schema.json",
    TEMPLATE / "hub" / "schemas" / "mission.schema.json",
    TEMPLATE / "hub" / "schemas" / "mission-observation.schema.json",
    TEMPLATE / "hub" / "schemas" / "skill-telemetry.schema.json",
    ...
    TEMPLATE / "hub" / "schemas" / "operation-authoring-types.schema.json",
    TEMPLATE / "hub" / "schemas" / "operation-authoring-catalog-request.schema.json",
    TEMPLATE / "hub" / "schemas" / "operation-authoring-catalog-result.schema.json",
    TEMPLATE / "hub" / "schemas" / "operation-authoring-plan-request.schema.json",
    TEMPLATE / "hub" / "schemas" / "operation-authoring-plan-result.schema.json",
    TEMPLATE / "hub" / "schemas" / "operation-authoring-launch-request.schema.json",
    TEMPLATE / "hub" / "schemas" / "operation-authoring-launch-result.schema.json",
    TEMPLATE / "hub" / "schemas" / "operation-authoring-guidance-request.schema.json",
    TEMPLATE / "hub" / "schemas" / "operation-authoring-guidance-result.schema.json",
    TEMPLATE / "hub" / "schemas" / "operation-authoring-operation-request.schema.json",
    TEMPLATE / "hub" / "schemas" / "operation-authoring-operation-result.schema.json",
    TEMPLATE / "hub" / "schemas" / "operation-authoring-error-result.schema.json",
    TEMPLATE / "hub" / "schemas" / "operation.schema.json",
    TEMPLATE / "hub" / "schemas" / "operations-snapshot.schema.json",
